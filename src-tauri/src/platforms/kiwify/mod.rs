...
impl Default for KiwifyDownloader {
    fn default() -> Self {
        Self::new()
    }
}

impl KiwifyDownloader {
    pub fn new() -> Self {
        Self
    }
}
...
#[async_trait]
impl PlatformDownloader for KiwifyDownloader {
    fn name(&self) -> &str {
        "kiwify"
    }
    ...
    async fn get_media_info(&self, url: &str) -> anyhow::Result<MediaInfo> {
        Ok(MediaInfo {
            title: "Kiwify Course".to_string(),
            author: String::new(),
            platform: "kiwify".to_string(),
